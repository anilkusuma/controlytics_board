...
public class UserController extends BaseController {
    ...
    public User getUserById(
        ...
        if (user.getAdditionalInfo().isObject()) {
            ...
            if (userCredentials.getResetToken() != null && !(userCredentials.getResetToken().isEmpty())) {
                additionalInfo.put("resetPasswordTokenEnabled", true);
            } else {
                additionalInfo.put("resetPasswordTokenEnabled", false);
            }
        }
        return user;
    }
    ...
    @ApiOperation(value = "Get the reset password link (getRestPasswordLink)",
